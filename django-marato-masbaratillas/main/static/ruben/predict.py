...
def neuronal(entrada):
    input_vars, output_var, data = get_data(test_file)
    input_data = data[input_vars]

    print("Making predictions")

    model_name = "./main/static/ruben/models/model.json"
    h5_name = "./main/static/ruben/models/model.h5"
    ...
    # Make prediction
    uniprediction = loaded_model.predict(entrada)
    ...
    #plt.show()
    #plt.savefig('./main/static/main/assets/img/background/neuronalnet.jpg')
    print("All done")
    return uniprediction
